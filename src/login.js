...
class Login extends React.Component {
    ...
    render() {
        if (this.props.isAuth) {
            return <Navigate to="/" isAuth={this.state.isAuth} />
        }
        if (this.state.isLogin) {
            return <Navigate to="/" isAuth={this.state.isLogin} />
        }
            ...
            <div className="main-container-login">
                ...
                <section className="main-login-form-container">
                    ...
                    <section className="login-form-section">
                        ...
                        {/* App Name Section */}
                        <div className="app-name-section-login"><h1>InstaTravel</h1></div>
                    ...
                    <div className="switch-to-signup-container">
                        ...
                        <span>Create an account <a href="/accounts/emailsignup">here</a></span>
